...
pub const Lexer = struct {
    ...
    pub fn nextToken(self: *Lexer) !Token {
        ...
        switch (c) {
            ...
            '-' => return self.makeToken(if (self.match('=')) .MinusEqual else .Minus),
            '+' => return self.makeToken(if (self.match('=')) .PlusEqual else .Plus),
            ';' => return self.makeToken(.Semicolon),
            '*' => return self.makeToken(if (self.match('=')) .StarEqual else .Star),
            '/' => return self.makeToken(if (self.match('=')) .SlashEqual else .Slash),
    ...
    fn identifier(self: *Lexer) Token {
        ...
        else if (std.mem.eql(u8, text, "import")) TokenType.Import
